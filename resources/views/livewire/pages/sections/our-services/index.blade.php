<div id="servicos" class="relative w-full py-20">
    <!-- bg light -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            @foreach ($limitedServices as $index => $service)
                <div class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition"
                    ...
                    <!-- Overlay -->
                    <div
                        class="absolute inset-0 bg-black/70 dark:bg-primary/90 flex flex-col
            ...
            @if (!empty($limitedServices) && count($this->filteredServices) > 5)
                <div class="flex items-center justify-center rounded-2xl shadow-lg bg-primary/90 dark:bg-secondary-black border border-primary hover:scale-105 transition cursor-pointer"
                    ...
                    <div class="text-center p-10">
                        ...
                        <p class="text-gray-200 mt-2 text-sm">Clique aqui e explore nossa lista completa de soluções.
                        </p>
                        <span
                            class="inline-block mt-4 px-6 py-2 bg-white text-primary font-semibold rounded-lg shadow hover:bg-gray-200 transition">
                            Explorar →
                        </span>
                    </div>
                </div>
            ...
            @if (empty($limitedServices))
                ...
                <div
                    class="col-span-3 flex flex-col items-center justify-center py-20 bg-primary/10 dark:bg-primary/20 border border-primary dark:border-primary rounded-2xl shadow-lg">
