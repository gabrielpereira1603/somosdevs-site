<div id="contato" class="relative w-full py-12 md:py-20 bg-secondary-white dark:bg-secondary-black">
    <!-- Fundo Light -->
    ...
    <div class="relative z-10 container mx-auto px-6">
        <div
            class="grid grid-cols-1 lg:grid-cols-2 overflow-hidden rounded-3xl border border-primary/20 dark:border-zinc-700 shadow-2xl bg-white/95 dark:bg-neutral-900 backdrop-blur-sm">

            <!-- Lado Esquerdo - Contato -->
            <div
                class="bg-secondary-black dark:bg-zinc-950 text-white p-8 md:p-10 flex flex-col justify-between min-h-full">
                <div>
                    <div class="flex items-center gap-3 mb-6">
                        <span
                            class="w-11 h-11 rounded-xl border border-white/15 bg-white/5 flex items-center justify-center">
                    ...
                    <p class="text-white/70 text-base md:text-lg leading-relaxed font-roboto mb-10 max-w-md">
                        Estamos presente em diversos Estados do Brasil com clientes de consultoria e alunos dos nossos
                        cursos.
                    </p>
                    ...
                    <div class="space-y-6">
                        <!-- Email -->
                        <div
                            class="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/5 p-4 hover:bg-white/10 transition">
            ...
            <div class="bg-white dark:bg-neutral-900 p-8 md:p-10">
                <div class="flex items-center gap-3 mb-8">
                    <span
                        class="w-11 h-11 rounded-xl border border-primary/20 bg-primary/10 flex items-center justify-center">
                ...
                <form action="#" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" placeholder="Digite seu telefone aqui"
                                class="w-full px-4 py-4 rounded-xl border border-gray-300 dark:border-zinc-700
                                       bg-gray-50 dark:bg-zinc-800/80 text-secondary-black dark:text-white
                                       placeholder:text-gray-400 dark:placeholder:text-gray-500
                                       focus:border-primary focus:ring-2 focus:ring-primary/30 outline-none transition">
                        ...
                        <div>
                            ...
                            <input type="text" name="company" placeholder="Digite o nome aqui"
                                class="w-full px-4 py-4 rounded-xl border border-gray-300 dark:border-zinc-700
                                       bg-gray-50 dark:bg-zinc-800/80 text-secondary-black dark:text-white
                                       placeholder:text-gray-400 dark:placeholder:text-gray-500
                                       focus:border-primary focus:ring-2 focus:ring-primary/30 outline-none transition">
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="6" placeholder="Digite sua mensagem aqui"
                            class="w-full px-4 py-4 rounded-xl border border-gray-300 dark:border-zinc-700
                                   bg-gray-50 dark:bg-zinc-800/80 text-secondary-black dark:text-white
                                   placeholder:text-gray-400 dark:placeholder:text-gray-500
                                   focus:border-primary focus:ring-2 focus:ring-primary/30 outline-none transition resize-none"></textarea>
                    </div>
